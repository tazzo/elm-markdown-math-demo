...
var _user$project$Main$example1 = '\n### Markdown Math\n\nTex maht **scriptscriptstyle** $$\\scriptscriptstyle \\int_{0}^{\\inf} e^{-x} dx$$\n\nTex maht **scriptstyle** $$\\scriptstyle \\int_{0}^{\\inf} e^{-x} dx$$\n\nTex maht **textstyle (default)** $$ \\int_{0}^{\\inf} e^{-x} dx$$\n\nTex maht **textstyle** $$\\textstyle \\int_{0}^{\\inf} e^{-x} dx$$\n\nTex maht **displaystyle** $$\\displaystyle \\int_{0}^{\\inf} e^{-x} dx$$\n\n#### limit\n$$\n\\displaystyle\\lim_{x \\to \\infty} e^{-x} = 0\n $$\n\nParagraphs are separated by a blank line.\n\n2nd paragraph. *Italic*, **bold**, and `monospace`. Itemized lists\nlook like:\n\n  * this one\n  * that one\n  * the other one\n\n> Block quotes are\n> written like so.\n\nUnicode is supported. ☺\n\n\n\nAn h2 header\n------------\n\nHere\'s a numbered list:\n\n 1. first item\n 2. second item\n 3. third item\n\n```python\nimport time\n# Quick, count to ten!\nfor i in range(10):\n    # (but not *too* quick)\n    time.sleep(0.5)\n    print i\n```\n\n\n\n### An h3 header\n\nNow a nested list:\n\n 1. First, get these ingredients:\n\n      * carrots\n      * celery\n      * lentils\n\n 2. Boil some water.\n\n 3. Dump everything in the pot and follow\n    this algorithm:\n\n\nHere\'s a link to [a website](http://foo.bar), to a [local\ndoc](local-doc.html), and to a [section heading in the current\ndoc](#an-h2-header).\n\n![example image](logo-elm.png \"An exemplary image\")\n\nMath equations go in like so: $$\\omega = d\\phi / dt$$.\n\n';
